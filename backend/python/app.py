...
MODEL_DIR = os.path.join(BASE_DIR, "py")
...
binary_model_path = os.path.join(MODEL_DIR, "binary_food_detection.pth")
...
food_model_path = os.path.join(MODEL_DIR, "indian_food_resnet50.pth")
